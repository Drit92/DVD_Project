...
# Top title + static nav chips (visual only)
st.markdown(
    """
...
# 2. CUSTOMER PROFILE SEGMENT RISK
# ====================================================
if nav_choice == "2. Customer profile segment risk":
    st.markdown('<div class="section-card">', unsafe_allow_html=True)
...
# 3. FINANCIAL STRESS & AFFORDABILITY
# ====================================================
if nav_choice == "3. Financial stress & affordability":
    st.markdown('<div class="section-card">', unsafe_allow_html=True)
...
# 4. BEHAVIOURAL RISK FROM PREVIOUS LOANS
# ====================================================
if nav_choice == "4. Behavioural risk from previous loans":
    st.markdown('<div class="section-card">', unsafe_allow_html=True)
...
# ====================================================
if nav_choice == "5. External credit scores":
    st.markdown('<div class="section-card">', unsafe_allow_html=True)
...
# 6. COMBINED RISK SCORE & RADAR
# ====================================================
if nav_choice == "6. Combined risk score & radar":
    st.markdown('<div class="section-card">', unsafe_allow_html=True)
